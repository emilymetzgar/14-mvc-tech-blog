...
<head>
    ...
    <!-- Popper JS (BootStrap PreRequisite) -->
...
<body>
        ...
        <div class="container-fluid bg-dark">
            <div class="row text-light">
                <div class="text-start col-sm-6">
                    <div class="fs-4"> The Best Blog Site Ever! -My mom.</div>
                </div>
                <div class="text-end col-sm-6">
                    <div class="fs-4"> Stay Awhile.</div>
                </div>
            </div>
        </div>
    </header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-3">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-3 test-start">
                    <a class="navbar-brand text-start" href="/">Best Blog</a>
                </div>
                <div class="col-sm-9 text-end collapse navbar-collapse" id="navbarToggler">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/profile" tabindex="0">My Dashboard</a>
                        </li>
                        {{#unless logged_in}}
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/logout" id="logout" tabindex="-1">Logout</a>
                        </li>
                        {{/if}}
                    </ul>
                    <form class="d-flex d-md-block d-lg-none" target="./blogSearch">
        ...
        <div class="row">
            ...
            {{!-- <aside class="col-lg-3 d-none d-lg-block">
                ...
                <div class="row">
                    ...
                    <div class="col-12"><a href="/post/{{post.id}}"><p>{{post.name}}</p></a></div>
                    {{/each}}
                </div>
            </aside> --}}
